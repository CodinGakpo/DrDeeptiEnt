  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[var(--color-bg)] text-[var(--color-ink)]">
      ...
      <div className="relative z-10">
        <header className="mx-auto max-w-6xl px-5 pt-6 pb-4 sm:px-8">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2 rounded-[1.5rem] border border-[var(--color-line)] bg-[rgba(255,255,255,0.72)] p-1.5 shadow-[0_10px_28px_rgba(36,53,51,0.06)]">
